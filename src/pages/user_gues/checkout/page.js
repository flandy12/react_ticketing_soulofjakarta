...
const PageCheckout = () => {
  ...
  let phone_number = searchParams.get("phone_number")
    ? searchParams.get("phone_number").replace(0, "")
    : "";
  let id_card_number = "";
            ...
            Object.keys(error_message).forEach((value, key) => {
              if (getLocalStorage.ticket_more_than_one_person === "1") {
                for ( let index = 0; index < getLocalStorage.total_ticket; index++) {
                  let error_messagee = document.getElementById(
                    value + "_err_" + index
                  );
                  if (error_messagee) {
  ...
  const SubmitTicket = e => {
    ...
    if (getLocalStorage.ticket_more_than_one_person === "1") {
      ...
      for (let index = 0; index < getLocalStorage.total_ticket; index++) {
        ...
        formdata.append(
          `phone_number`,
          "62" + document.getElementById(`phone_number_${index}`).value
        );
      ...
      ticketElements.push(
        <div key={index}>
          ...
          <div className="mb-6">
            ...
            <p
              className="text-red-600 error-text"
              id={`id_card_number_err_${index}`}></p>
          </div>
          <div className="mb-6">
            <label className="block mb-2 text-sm font-medium text-gray-900">
              Nomor Ponsel*
          ...
          .then(res => {
            if (res.success === true) {
              ...
              let additional_cost_ =
                ...
                100;
              let total_price =
                parseInt(searchParams.get("price")) + additional_cost_;
                      ...
                      <div className="justify-between p-4 max-md:p-0 leading-normal">
                        ...
                        <div className="space-y-2 mt-2">
                          <p className="font-normal">
                            Dates : {getLocalStorage.start_date}{" "} {getLocalStorage.end_date ? `- ${getLocalStorage.end_date}` : ""}
                          </p>
                          <p className="font-normal">
                            Time : {getLocalStorage.start_time}{" "}
                            {getLocalStorage.end_time ? `- ${getLocalStorage.end_time}`: ""}{" "}
                            WIB
                          </p>
                          <p className="font-normal">
                  ...
                  <div className="space-y-3 bg-white border border-gray-200 rounded-lg shadow md:flex-row px-5 py-5">
                    ...
                    <div>
                      <form
                        id="formDataUser"
                        className={`${
                          getLocalStorage.ticket_more_than_one_person === "0"
                            ? "block"
                            : "hidden"
                        }`}>
                        <div className="mb-6">
              ...
              <div className="relative bg-white rounded-lg shadow ">
                <div className="p-4 md:p-5 text-center">
                  ...
                  <span className="text-gray-500 px-3">
                    Mohon menunggu untuk melakukan pembayaran. Mohon tidak
                    merefresh dan pindah dari halaman ini. Terima kasih
                  </span>
                </div>
              </div>
            </div>
