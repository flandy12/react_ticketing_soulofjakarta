...
const LayoutPayment = () => {
  ...
  const getLocalStorage = JSON.parse(
    localStorage.getItem(searchParams.get("generate"))
  );
        ...
        <>
          <div className="flex flex-col justify-between space-y-3">
            <div className="bg-blue-50 p-2 rounded border font-semibold capitalize">
              ...
              <span className="uppercase">{getLocalStorage.payment_code}</span>
            </div>
            ...
            <div className="mt-5">
              ...
              <div className="flex justify-between mt-5">
                ...
                <span className="font-semibold ">
                  IDR {new Intl.NumberFormat().format(getLocalStorage.price)}
                </span>
              </div>
      ...
      return (
        <>
          <div className="flex flex-col max-md:flex-col justify-between space-y-3">
            <div className="bg-blue-50 p-2 rounded border font-semibold capitalize">
              {/* {searchParams.paymenttype === 'bank_transfer'? 'Virtual' : ''}  */}
              <span className="uppercase">{getLocalStorage.payment_name}</span>
            </div>
          </div>
          <div className="mt-4">
            <div className="mt-5">
              ...
              <button className="bg-yellow-300 py-2 px-5 mt-5 rounded font-semibold">
                <Link to={getLocalStorage.redirect_url} target={"_blank"}>
                  Open App
                </Link>
              </button>
            </div>
