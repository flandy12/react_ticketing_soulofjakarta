    ...
    <nav className="bg-black sticky-top">
        <div className="flex flex-wrap items-center mx-auto p-4 max-md:justify-between container ">
            ...
            <ul className="font-medium flex flex-col max-md:justify-between p-4 md:p-0 mt-4 border rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 text-gray-400 opacity-90">
                ...
                <li>
                <Link to="/tiket-saya" className={`block py-2 px-3 bg-blue-700 rounded ${getUrl === 'Tiket Saya' ? 'text-orange-300' : ''} bg-transparent md:p-0`}>Tiket Saya</Link>
                </li>
                <li>
                <Link to="/media-partner" className={`block py-2 px-3 bg-blue-700 rounded ${getUrl === 'media-partnerr' ? 'text-orange-300' : ''} bg-transparent md:p-0`}>Media Partner</Link>
                </li>
                <li>
                <Link to="/give-away" className={`block py-2 px-3 bg-blue-700 rounded ${getUrl === 'give-away' ? 'text-orange-300' : ''} bg-transparent md:p-0`}>Give Away</Link>
                </li>
